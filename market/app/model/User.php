...
class User extends Connection {
    ...
    public function getData($data)
    {
        ...
        $modal = (empty($data['status']) || $data['status'] != 'del')?'': Helper::getModal('confirmDelete','Do you want Delete?','<h2>Attention!</h2>This product wil be deleted.<br><b>Do you confirm this?</b>','Confirm','front.php?class='.CLASSLINK.'&status=deleted&key='.$data['key'],'danger');
