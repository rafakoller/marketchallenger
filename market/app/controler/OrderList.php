...
class OrderList extends Order
{
    ...
    public function getData($data = null)
    {
        ...
        $pagination = Helper::getPagination(self::LIMITE,$pagecurr,'order','OrderList');
        ...
        {
            $modal = Helper::getModal('confirmDelete','Do you want Delete?','<h2>Attention!</h2>Order id '.str_pad($data['key'], 4 , '0' , STR_PAD_LEFT).' will be deleted.<br><b>Do you confirm that?</b>','Confirm','front.php?class=Order&status=deleted&key='.$data['key'],'danger');
        }
