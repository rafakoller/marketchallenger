 ...
 */
class TypeProductForm extends Market
{
    ...
    public function getData($data = null)
    {
        ...
        $this->dataclass = $alert.
                            ...
                            <div class="row flex-between-center mb-4 g-3 card overflow-hidden shadow">    
                                <form class="p-3" action="front.php?class=TypeProduct" method="post" autocomplete="off">
                                    <div class="row">
                                    ...
                                    <div class="row p-3">    
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4" style="float: left">
                                            <a class="btn btn-secondary col-12" href="front.php?class=TypeProductList">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>';
